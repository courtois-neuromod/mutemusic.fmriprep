...
#SBATCH --output=/lustre04/scratch/bpinsard/mutemusic.fmriprep/code/fmriprep_study-cneuromod.mutemusic_sub-06_ses-001.out
#SBATCH --error=/lustre04/scratch/bpinsard/mutemusic.fmriprep/code/fmriprep_study-cneuromod.mutemusic_sub-06_ses-001.err
