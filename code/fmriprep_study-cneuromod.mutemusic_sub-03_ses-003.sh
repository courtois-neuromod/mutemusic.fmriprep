...
#SBATCH --job-name=fmriprep_study-cneuromod.mutemusic_sub-03_ses-003.job
#SBATCH --output=/localscratch/bpinsard-beluga4/cneuromod.mutemusic.fmriprep/code/fmriprep_study-cneuromod.mutemusic_sub-03_ses-003.out
#SBATCH --error=/localscratch/bpinsard-beluga4/cneuromod.mutemusic.fmriprep/code/fmriprep_study-cneuromod.mutemusic_sub-03_ses-003.err
...
if [ -e $LOCAL_DATASET/workdir/fmriprep_wf/resource_monitor.json ] ; then cp $LOCAL_DATASET/workdir/fmriprep_wf/resource_monitor.json /scratch/bpinsard/fmriprep_study-cneuromod.mutemusic_sub-03_ses-003_resource_monitor.json ; fi 
if [ $fmriprep_exitcode -ne 0 ] ; then cp -R $LOCAL_DATASET /scratch/bpinsard/fmriprep_study-cneuromod.mutemusic_sub-03_ses-003 ; fi 
